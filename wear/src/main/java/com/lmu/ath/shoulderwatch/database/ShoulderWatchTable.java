...
public class ShoulderWatchTable {
    ...
    private static final String DATABASE_CREATE = "create table "
            ...
            + COLUMN_LOCATION_X + " real null, "
            + COLUMN_LOCATION_Y + " real null, "
            + COLUMN_ENVIRONMENT + " text null, "
            + COLUMN_DEVICE_ANALOG + " text null, "
            + COLUMN_DEVICE_DIGITAL + " text null, "
            + COLUMN_DEVICETYPE + " text null, "
            + COLUMN_CONTENT + " text null, "
            + COLUMN_SURF_RATING + " integer null, "
            + COLUMN_RELATIVE_POSITION + " integer null, "
            + COLUMN_CROWD_DENSITY + " text null, "
            + COLUMN_DEFENCE_LEVEL + " text null"
            + ");";
